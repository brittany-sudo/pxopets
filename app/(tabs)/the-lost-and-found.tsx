  ...
  const products = [
    {
      id: 'lost-wallet',
      name: 'Lost Wallet',
      description: 'Black leather wallet found near food court',
      price: 0,
      icon: 'credit-card',
    ...
    },
    {
      id: 'found-keys',
      name: 'Set of Keys',
      description: 'House keys with keychain charm',
      price: 0,
      icon: 'key',
      category: 'Personal Items'
    },
    {
      id: 'abandoned-phone',
      name: 'Mobile Phone',
      description: 'Smartphone found in restroom',
      price: 0,
      icon: 'mobile',
    ...
    },
    {
      id: 'lost-jacket',
      name: 'Denim Jacket',
      description: 'Blue jacket left in arcade area',
      price: 0,
      icon: 'user',
      category: 'Clothing'
    },
    {
      id: 'found-bag',
      name: 'Backpack',
      description: 'Red backpack with school supplies',
      price: 0,
      icon: 'briefcase',
      category: 'Personal Items'
    },
    {
      ...
      description: 'Black frame glasses in case',
      price: 0,
      icon: 'eye',
      category: 'Personal Items'
    }
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <RNView style={styles.headerRow}>
          <Text style={styles.locationTitle}>THE LOST & FOUND</Text>
        </RNView>
        ...
        <RNView style={styles.productsGrid}>
          {products.map((product) => (
            ...
            >
              ...
              <Text style={styles.productPrice}>{product.price === 0 ? 'FREE' : `${product.price} 🔍`}</Text>
              {cart.has(product.id) && (
        ...
        {cart.size > 0 && (
          <RNView style={styles.cartSummary}>
            ...
            <Pressable style={styles.checkoutButton}>
              <Text style={styles.checkoutText}>Claim Items</Text>
            </Pressable>
          </RNView>
        )}
