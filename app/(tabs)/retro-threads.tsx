...
export default function RetroThreadsScreen() {
  ...
  const products = [
    {
      ...
      description: 'Classic cotton tee with retro band graphics',
      price: 25,
      icon: 'shirt',
      category: 'Tops'
    },
    ...
    },
    {
      ...
      description: 'Retro-style jeans with perfect fit',
      price: 38,
      icon: 'female',
      category: 'Bottoms'
    },
    {
      ...
      description: 'Chunky sneakers with 90s vibes',
      price: 55,
      icon: 'heart',
      category: 'Shoes'
    },
    {
      id: 'bucket-hat',
      name: 'Bucket Hat',
      description: 'Trendy bucket hat in various colors',
      price: 18,
      icon: 'circle',
    ...
    },
    {
      id: 'crop-top',
      name: 'Crop Top',
      description: 'Cute cropped top for layering',
      price: 22,
      icon: 'star',
      category: 'Tops'
    }
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <RNView style={styles.headerRow}>
          <Text style={styles.locationTitle}>RETRO THREADS</Text>
        </RNView>
