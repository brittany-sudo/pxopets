...
export default function PixelPagesScreen() {
  ...
  const products = [
    {
      id: 'fantasy-novel',
      name: 'Fantasy Novel',
      description: 'Epic adventure with magic and dragons',
      price: 15,
      icon: 'book',
      category: 'Fiction'
    },
    {
      id: 'comic-book',
      name: 'Comic Book',
      description: 'Superhero adventures in full color',
      price: 8,
      icon: 'star',
      category: 'Comics'
    },
    ...
    },
    {
      id: 'journal',
      name: 'Blank Journal',
      description: 'Perfect for writing and sketching',
      price: 10,
      icon: 'pencil',
      category: 'Stationery'
    }
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <RNView style={styles.headerRow}>
          <Text style={styles.locationTitle}>PIXEL PAGES</Text>
        </RNView>
